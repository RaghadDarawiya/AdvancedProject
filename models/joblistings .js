...
class JobListing {
  constructor(jobid , id, jtitle, jdescription, jrequirements, SalaryRange, dateposted) {
    this.jobid = jobid;
    this.id = id;
    this.jtitle = jtitle;
  ...
  save(callback) {
    ...
    db.query(
      ...
      [this.jobid , this.id ,this.jtitle, this.jdescription, this.jrequirements, this.SalaryRange, this.dateposted],
      (err, result) => {
        if (err) {
